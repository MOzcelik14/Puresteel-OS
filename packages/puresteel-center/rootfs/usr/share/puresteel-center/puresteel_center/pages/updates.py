...
class UpdatesPage(QWidget):
    ...
    def set_language(self,lang):
        ...
        self.note.setText("Güncellemeden önce mümkünse Timeshift snapshot'ı oluşturulur. Kernel/NVIDIA/firmware paketleri kritik olarak işaretlenir." if lang=="tr" else "A Timeshift snapshot is created when possible before updating. Kernel/NVIDIA/firmware packages are marked as critical.")
